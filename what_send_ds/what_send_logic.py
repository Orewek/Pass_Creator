...
def add_new_path(file_path: str, path: str) -> None:
...
def whole_path_list(pass_ways: str) -> None:
    """
...
def choose_the_path(pass_ways: str, what_we_need: int) -> str:
    """
