...
class TestPassword(unittest.TestCase):
    ...
    def test_tune_special_symbols(self):
        ...
        self.assertTrue(tune_special_symbols(password, '_-'), password_without_underscore_and_dash)
    ...
    def test_sanitize_password(self):
        ...
        self.assertTrue(sanitize_password(password, 'diglow'), password_without_digits_and_lower)
