...
class TestPassword(unittest.TestCase):
    ...
    def test_special_symbols(self):
        ...
        self.assertTrue(tp.tune_symbols(password, '_-'), password_without_underscore_and_dash)
    ...
    def test_up_low_dig(self):
        ...
        self.assertTrue(tp.up_low_dig(password, 'diglow'), password_without_digits_and_lower)
